...
class AutologoutSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['use_alt_logout_method'] = array(
      '#type' => 'checkbox',
    ...
    $form['table'] = array(
      ...
      '#states' => array(
        'visible' => array(
          ...
          ':input[name="role_logout"]' => array('checked' => TRUE),
        ),
      ),
    );
